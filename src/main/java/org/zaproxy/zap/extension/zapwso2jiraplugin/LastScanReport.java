...
public class LastScanReport {
    ...
    private static LastScanReport instance = new LastScanReport();

    private LastScanReport() {
    }

    public static synchronized LastScanReport getInstance() {
        if (instance == null) {
            instance = new LastScanReport();
        }
        return instance;
    }
